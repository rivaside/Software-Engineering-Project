    ...
    Private Sub Student_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            While READER2.Read
                ...
                StudentGridLSTBOX.Items.Add("Exam 1: " + CStr(READER2.GetInt64("Exam_1_1")))
                StudentGridLSTBOX.Items.Add("Exam 2: " + CStr(READER2.GetInt64("Exam_2_1")))
                ...
                StudentGridLSTBOX.Items.Add("Exam 1: " + CStr(READER2.GetInt64("Exam_1_2")))
                StudentGridLSTBOX.Items.Add("Exam 2: " + CStr(READER2.GetInt64("Exam_2_2")))
                ...
                StudentGridLSTBOX.Items.Add("Exam 1: " + CStr(READER2.GetInt64("Exam_1_3")))
                StudentGridLSTBOX.Items.Add("Exam 2: " + CStr(READER2.GetInt64("Exam_2_3")))
                ...
                StudentGridLSTBOX.Items.Add("Exam 1: " + CStr(READER2.GetInt64("Exam_1_4")))
                StudentGridLSTBOX.Items.Add("Exam 2: " + CStr(READER2.GetInt64("Exam_2_4")))
                ...
                StudentGridLSTBOX.Items.Add("Exam 1: " + CStr(READER2.GetInt64("Exam_1_5")))
                StudentGridLSTBOX.Items.Add("Exam 2: " + CStr(READER2.GetInt64("Exam_2_5")))
